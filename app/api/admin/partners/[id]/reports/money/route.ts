...
/**
 * `GET /api/admin/partners/[id]/reports/money` (backlog 9.4b الأداء tab) — B3, see the sales
 * route's sibling for the shared shape.
 */
...
export async function GET(req: NextRequest, { params }: { params: Params }) {
  ...
  return handleMoneyReport(req, { partnerId: id });
}
