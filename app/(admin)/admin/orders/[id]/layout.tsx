...
// `admin/orders/[id]/page.tsx` is a client component and cannot export metadata itself —
// backlog 10.30. Reads only the display identifier (same `طلب #<8>` format the page itself
// renders, `app/(admin)/admin/orders/[id]/page.tsx`), falling back to the plural label if the
